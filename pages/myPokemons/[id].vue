<template>
  ...
  import type { ICustomPokemon, IPokemon } from "~/types/pokemon";
  ...
  const pokemon = ref<ICustomPokemon | null>(null);
  const showAllMoves = ref(false);
  
  async function handleClick() {
    const value = (await getData(`my-pokemons/${route.params.id}`)) as ICustomPokemon;
    pokemon.value = value;
  }
